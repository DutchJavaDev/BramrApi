...
CREATE TABLE `AspNetRoles` (
    ...
    `NormalizedName` varchar(85) CHARACTER SET utf8mb4 NULL,
...
CREATE TABLE `AspNetUsers` (
    ...
    `NormalizedUserName` varchar(85) CHARACTER SET utf8mb4 NULL,
    `Email` varchar(256) CHARACTER SET utf8mb4 NULL,
    `NormalizedEmail` varchar(85) CHARACTER SET utf8mb4 NULL,
...
VALUES ('20201125095808_Init', '3.1.10');
